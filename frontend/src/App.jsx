  ...
  <Router>
    <Routes>
     ...
     <Route
        ...
        <Route path="Billing" element={<ProtectedRoute allowedRoles={['staff', 'admin', 'admin']}> {/* Assuming staff and admin handle billing */}
          <BillingAndInvoice />
        </ProtectedRoute>} />
        ...
        />
        <Route path="StaffForm" element={<ProtectedRoute allowedRoles={['admin']}>
          <StaffForm />
        </ProtectedRoute>} />
